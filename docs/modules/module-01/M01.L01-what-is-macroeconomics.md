...
!!! info "Key Diagram"
    ![Figure 1: The Production Possibilities Frontier (PPF). Points on the curve are efficient; inside is inefficient; outside is unattainable.](../../assets/diagrams/01-ppf.png)  
    *Figure 1: The Production Possibilities Frontier (PPF). Points on the curve are efficient; inside is inefficient; outside is unattainable.*
