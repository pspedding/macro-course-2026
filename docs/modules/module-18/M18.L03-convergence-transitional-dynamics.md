...
<svg viewBox="0 0 1280 470" width="100%" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="320" y="28" text-anchor="middle" class="title">Phase diagram</text>
  ...
  <line x1="100" y1="338" x2="560" y2="118" class="curve" stroke="#2ca02c" />
  <line x1="360" y1="170" x2="360" y2="360" class="guide" />
  <text x="500" y="130" class="small" fill="#d62728">sk^α</text>
  <text x="455" y="111" class="small" fill="#2ca02c">(δ+n+g)k</text>
  <text x="350" y="382" class="small">k*</text>
  <line x1="150" y1="345" x2="320" y2="345" stroke="#555" stroke-width="2" marker-end="url(#arrow)" />
  <line x1="520" y1="345" x2="390" y2="345" stroke="#555" stroke-width="2" marker-end="url(#arrow)" />
  <text x="125" y="330" class="small">k̇ > 0</text>
  <text x="470" y="330" class="small">k̇ < 0</text>

  <text x="955" y="28" text-anchor="middle" class="title">Time paths toward the steady state</text>
  <line x1="700" y1="360" x2="1220" y2="360" class="axis" />
  <line x1="700" y1="360" x2="700" y2="60" class="axis" />
  <line x1="700" y1="180" x2="1220" y2="180" class="guide" />
  <path d="M 735 320 C 820 280, 900 230, 960 205 S 1090 184, 1190 181" class="curve" stroke="#1f77b4" />
  <path d="M 735 90 C 815 115, 905 145, 980 160 S 1090 175, 1190 179" class="curve" stroke="#ff7f0e" />
  <text x="1120" y="174" class="small">k*</text>
  <text x="760" y="315" class="small">From below</text>
  <text x="760" y="92" class="small">From above</text>
  <text x="835" y="390" class="small">Time</text>
  <text x="665" y="210" transform="rotate(-90 665 210)" text-anchor="middle" class="small">k(t)</text>
  <defs>
